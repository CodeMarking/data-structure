...
public class BinaryTree<T> implements BinaryTTree<T> {
     ...
     */
    @Override
    public List<Integer> preOrderTraversal(BinaryTreeIntData root) {

        List<Integer> result = new ArrayList<>();
        if (root == null) {
            return result;
        }
        Stack<BinaryTreeIntData> stack = new Stack<>();
        stack.push(root);
        while (!stack.isEmpty()) {
            BinaryTreeIntData node = stack.pop();
            result.add(node.vue);
            if (node.right != null) {
    ...
    private List<Integer> preOrderTraversal2(BinaryTreeIntData root) {
        List<Integer> result = new ArrayList<>();

        if (root == null) {
            return result;
        }
        List<Integer> left = this.preOrderTraversal2(root.left);
        List<Integer> right = this.preOrderTraversal2(root.right);
    ...
    private List<Integer> inOrderTraversal(BinaryTreeIntData root)
    {
        List<Integer> result = new ArrayList<>();
        if (root == null) {
            return result;
        ...
        List<Integer> right = inOrderTraversal(root.left);
        result.addAll(left);
        result.add(root.vue);
        result.addAll(right);
        return result;
     ...
     * @return
     */
    private List<Integer> inOrderTraversalNoRecur(BinaryTreeIntData root) {
        List<Integer> result = new ArrayList<>();
        if (root == null) {
            return result;
        }
        Stack<BinaryTreeIntData> stack = new Stack<>();
        BinaryTreeIntData current = root;
